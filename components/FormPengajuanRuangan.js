  ...
  return (
    <>
      <div className="fixed bottom-0 right-0 p-3">
        <button
          className="animate-bounce w-14 h-14 text-xs text-center  bg-indigo-600 text-white text-gray-100 rounded-full focus:outline-none"
          type="button"
          onClick={() => setOpen(true)}
        >
          <PlusIcon className="h-5 w-5 my-auto mx-auto" />
          Ajukan
        </button>
      </div>
            ...
            >
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                ...
                <div className="mt-5 sm:mt-4 sm:ml-10 sm:pl-4 sm:flex ">
                  <button
                    type="button"
                    className="inline-flex mb-2 justify-center w-full text-xs rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600  font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-0 focus:ring-offset-2 focus:ring-red-500 sm:w-auto "
                  ...
                  <button
                    type="button"
                    className=" mr-3 w-full mb-2 text-xs inline-flex justify-center rounded-md border border-gray-300 px-4 py-2 bg-white  font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-0 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0  sm:w-auto "
                    onClick={() => setOpen(false)}
                    ref={cancelButtonRef}
                  >
                    Batal
