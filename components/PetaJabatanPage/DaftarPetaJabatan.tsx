                    ...
                    <tbody>
                        {dataTable.map((data, dataIdx) => (
                            ...
                            >
                                ...
                                <td
                                    className="whitespace-nowrap px-6 text-xs font-medium text-indigo-800 cursor-pointer"
                                ...
                                <td className="whitespace-nowrap px-6 py-4 text-xs font-medium text-gray-900">
                                    <button
                                        type="button"
                                        className="text-xs px-[11px] py-[7px] rounded-md font-medium text-white bg-[#4F46E5] hover:bg-indigo-700 focus:outline-none"
