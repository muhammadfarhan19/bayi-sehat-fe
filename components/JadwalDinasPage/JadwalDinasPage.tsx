...
export default function JadwalDinasPage() {
    ...
    const {
        data: dataTable,
        isValidating,
    } = useCommonApi<GetRekapPegawaiReq, RekapDataPegawai[]>(RekapDinasAPI.GET_DINAS_PEGAWAI_SCHEDULE, pegawai_id ? { pegawai_id: Number(pegawai_id) } : {}, { method: 'GET' });
                                            ...
                                            {(dataTable || []).map((data, dataIdx) => (
                                                ...
                                                >
                                                    ...
                                                    <td
                                                        ...
                                                        onClick={() =>
                                                            (window.location.href = `/notification/detail?dinas_id=${data.dinas_id}`)
                                                        }
                                                    >
                                                        {data.no_sp}
                                                    </td>
