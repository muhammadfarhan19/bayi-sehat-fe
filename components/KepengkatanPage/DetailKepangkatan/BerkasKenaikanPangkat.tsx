...
const dummyListJenisKepangkatan = ['Reguler', 'Jabatan Struktural (JS)'];

const dummyListBerkas = ['Nota Usul', 'Surat Pengantar'];
...
function BerkasKenaikanPangkat() {
  return (
    <>
      ...
      <section aria-labelledby="section-1-title">
        <div className="rounded-lg bg-white shadow">
          <h3 className="px-6 pt-4 text-xl font-medium leading-6 text-gray-700">Berkas Kenaikan Pangkat</h3>
        ...
        <div className="rounded-lg bg-white shadow">
          <div className="rounded-[8px] bg-white px-6 pb-6 pt-4">
            ...
            <p className="text-sm font-light leading-8 text-gray-700">
              Berkas fisik yang tidak ditanda tangani oleh pejabat yang seharusnya wajib melampirkan surat penunjukkan
              PLT
            </p>
