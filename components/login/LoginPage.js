  ...
  const handleLogin = async (handleSubmit) => {
    ...
    try {
      ...
      if (login.responseData.status === "SUCCESS") {
        ...
        Cookies.set("token", login.responseData.data.access_token, {
          expires: exp,
        });
        Cookies.set("refreshtoken", login.responseData.data.refresh_token, {
          expires: refreshexp,
        });
        router.push("/");
      } else {
              ...
              <div>
                ...
                {errors.username && errors.username.type === "required" && (
                  <p class="mt-1 text-red-500 text-xs">
                    Mohon masukkan username Anda yang terdaftar di IntraDikti
                  </p>
                )}
              </div>
              <div>
                ...
                <div className="mt-1 flex rounded-md shadow-sm">
                  ...
                  {HidePassword ? (
                    <button
                      ...
                      className="btn -ml-px relative inline-flex items-center space-x-2 px-4 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none"
                    >
                      <EyeIcon
                    ...
                    <button
                      ...
                      className="btn -ml-px relative inline-flex items-center space-x-2 px-4 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-white hover:bg-gray-100 "
                    >
                      <EyeOffIcon
                        className="h-5 w-5 text-gray-400"
                        aria-hidden="true"
