...
export default function DaftarKepegawaian() {
            ...
            <div className='px-6'>
                ...
                {showAdvancedFilter && (
                    <div className="flex w-full flex-row gap-x-[16px]">
                        ...
                        <div className="w-[202px] pb-2">
                            <p className="mb-[4px] text-[14px] font-normal">Kelas</p>
                            <select className="block w-full appearance-none rounded-md border border-gray-300 px-3 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                <option value="10">Semua</option>
                                <option value="20">Lorem Ipsum</option>
                                <option value="30">Lorem Ipsum</option>
                                ...
                                <tbody>
                                    {dataTable.map((data, dataIdx) => (
                                        ...
                                        >
                                            ...
                                            <td className="whitespace-nowrap px-6 text-xs font-medium text-gray-900">{data.kelas}</td>
                                            ...
                                            <td className="whitespace-nowrap px-6 py-4 text-xs font-medium text-gray-900">
                                                <button
                                                    type="button"
                                                    className="text-xs px-[11px] py-[7px] rounded-[4px] font-medium bg-indigo-600 text-gray-50 focus:outline-none"
                                                >
                                                    Detail
                                                </button>
                                                <button
                                                    type="button"
                                                    className="mx-2 text-xs px-[11px] py-[7px] rounded-[4px] font-medium border-[#4F46E5] border-[1px] text-indigo-600 focus:outline-none"
                                                >
                                                    Edit
                                                </button>
                                            </td>
