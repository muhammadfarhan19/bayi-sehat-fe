...
import FormModalKompetensi from './FormModalKompetensi';

export default function ListPegawaiKompetensi() {
        ...
        <>
          <div className="rounded-md bg-white px-6">
            <div className="flex flex-row py-6">
              <p className="text-lg font-medium text-gray-900">Peningkatan Kompetensi</p>
          ...
          {formModalState?.open && (
            <FormModalKompetensi open={formModalState?.open} setOpen={(open: boolean) => handleShowForm(open)} />
          )}
        </>
      )}
    </>
