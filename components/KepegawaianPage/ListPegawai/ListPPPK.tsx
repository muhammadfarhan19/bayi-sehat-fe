...
function ListPPPK(props: ListPPPKProps) {
  const {
    pageHeaderTitle = '',
    unitKerjaId,
    onClickEachPegawai,
  ...
  const changeFilterState = (inputState: Partial<GetPegawaiListReq>) => {
    ...
    inputTimeout.current = setTimeout(() => setFilterPPPK(newState), pageAffected ? 0 : 500);
  };
          ...
          <div className="align-start inline-block min-w-full sm:px-0 lg:px-0">
            <div className="sm:rounded-lg">
              ...
              <Pagination
                ...
                totalData={PPPKList ? PPPKList?.pagination.total_data : 0}
                perPage={filterPPPK.per_page}
                page={filterPPPK.page}
              />
            </div>
          </div>
        </div>
