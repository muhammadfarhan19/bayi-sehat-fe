            ...
            <div className="px-6">
                <div className="py-6 flex flex-row">
                    ...
                    <div className="flex ml-auto">
                        ...
                        <div className="flex">
                            <button onClick={() => router.push('/')} className="inline-flex items-center px-3 focus:outline-none rounded-md p-2 bg-indigo-600 text-sm border border-indigo-600 text-white ml-1 hover:bg-indigo-700">
                            ...
                            <table className="w-full rounded-lg bg-gray-100 table-auto">
                                ...
                                {dataTable.map((data, dataIdx) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-xs font-medium text-indigo-800 cursor-pointer">
                                                {data.nama}
                                            </td>
