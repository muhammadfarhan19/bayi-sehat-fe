...
export default function ProfilePegawai(props: ID) {
  ...
  return (
    <div id={props.id}>
      ...
      <ContentLabelledItems subtitle="NIP" value={personalPegawaiData?.nip} />
      <ContentLabelledItems subtitle="Pangkat" value={personalPegawaiData?.pangkat} />
      <ContentLabelledItems subtitle="Golongan" value={personalPegawaiData?.golongan} />
      ...
      />
      <ContentLabelledItems subtitle="Jabatan" value={personalPegawaiData?.jabatan} />
      <ContentLabelledItems subtitle="Pendidikan Terakhir" value={getPendidikan?.slice(-1).pop()?.jenjang_str} />
      <ContentLabelledItems subtitle="Karpeg" value={personalPegawaiData?.karpeg} />
      <ContentLabelledItems subtitle="Masa Kerja" value={personalPegawaiData?.masa_kerja} />
      <ContentLabelledItems subtitle="Masa Kerja" value={personalPegawaiData?.masa_kerja_kepangkatan} />

      <div className="mt-5 mb-2 w-1/12 border-b-2 border-black" />
      <LabelledRowsItem separatorTop="mt-0 mb-2" title="Data Diri Pribadi" />
      <ContentLabelledItems subtitle="NIK" value={personalPegawaiData?.ktp} />
      <ContentLabelledItems
      ...
      />
      <ContentLabelledItems subtitle="Alamat" value={personalPegawaiData?.alamat} />
      <div className="mt-5 mb-2 w-1/12 border-b-2 border-black" />
      ...
      {getPendidikan?.map(data => (
        <div className="mb-2" key={data.riwayat_id}>
          <h6 className="flex flex-1 text-[12px]">{`${data.jenjang_str} , ${data.pt}`}</h6>
