                    ...
                    {notification ?
                        notification[date as keyof typeof notification].map((each) => (
                            <tr className="flex flex-col px-[24px] py-[16px]">
                                <p className="text-[#4F46E5] text-[14px]">{each.isi_penugasan}</p>
                                <div className="inline-flex mt-[8px]">
                                    ...
                                    <td className=" px-2 text-[14px] font-[400] text-[#6B7280]">{convertIndonesiaFormat(each.tgl_mulai)} - {convertIndonesiaFormat(each.tgl_selesai)}</td>
                                </div>
