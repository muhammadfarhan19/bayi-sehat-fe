...
export default function NotificationListPage() {
    ...
    return (
        <div className="overflow-hidden rounded-lg bg-white pb-6 shadow mb-[24px]">
            <div className="my-4 px-7 py-1">
                <h3 className="text-xl font-semibold tracking-wider text-gray-700 inline-flex">
                    <span className="relative inline-block">
                        ...
                        <span className="absolute -top-1 right-0 inline-flex items-center justify-center px-1 py-1 text-[10px] font-bold leading-none text-red-100 bg-red-600 rounded-full">
                            {notification ?
                    ...
                    {notification ?
                        Object.keys(notification).map((each: string) => (
                            <tr className="flex flex-col px-[24px] py-[16px]">
                                <p className="text-[#4F46E5] text-[14px]">Jangan lupa ya kamu ada <span className="font-bold">{notification[each as keyof typeof notification].length} Kegiatan!</span></p>
                                <div className="flex flex-row">
                                    <div className="inline-flex mt-[8px]">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-[16px] h-[16px] my-auto">
                                    ...
                                    <div
                                        onClick={() => handleDetail(each)}
                                        className="inline-flex gap-x-1 ml-auto cursor-pointer"
                                    >
                                        <p className="text-[#4338CA] my-auto text-[14px]">Selengkapnya</p>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-[10px] h-[10px] text-[#4338CA] my-auto">
                        ...
                        :
                        <tr className="flex flex-col px-[24px] py-[16px]">
                            <p className="text-[#4F46E5] text-[14px]">Kamu belum ada kegiatan!</p>
                        </tr>
                    }
