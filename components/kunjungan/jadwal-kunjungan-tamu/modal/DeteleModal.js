...
export default function DeleteModal({ data, close, result }) {
    const [open, setOpen] = useState(true)

    const handleDelete = async () => {
        try {
            const post = await request(config.apiHost + '/buku-tamu/delete/' + data, '', 'delete', true);
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            Apakah anda yang menghapus data? Seluruh perubahan akan terhapus secara permanen dan tidak dapat dikembalikan.
                                        </p>
                                    </div>
                                </div>
                            </div>
