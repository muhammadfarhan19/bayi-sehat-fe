...
import { DaftarTransaksi } from '../../../components/KepegawaianPage/DaftarTransaksiPage';
...
export default withReduxPage()(withAuthenticatedPage()(DaftarTransaksiPage));
