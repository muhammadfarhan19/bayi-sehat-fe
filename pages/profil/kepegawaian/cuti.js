      ...
      <div className="bg-white rounded-md shadow ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 px-5 pb-5 gap-4">
          <div className="border-r">
            <div className="">Kuota cuti</div>
            <div className="">10/40 (20%)</div>
          </div>
          <div className="border-r">
            <div className="">Kuota tahun 2021</div>
            <div className="">40</div>
          </div>
          <div className="border-r">
            <div className="">Jumlah cuti yang pernah diambil</div>
